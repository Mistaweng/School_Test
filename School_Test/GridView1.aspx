...
<%--<%@ Page Language="VB" AutoEventWireup="false" CodeFile="YourPage.aspx.vb" Inherits="YourPage" %>
...
<body>
    ...
    <div id="dvGrid" style="padding: 10px; width: 450px">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowDataBound="OnRowDataBound"
                    DataKeyNames="BL_ID" OnRowEditing="OnRowEditing" OnRowCancelingEdit="OnRowCancelingEdit" PageSize="3" AllowPaging="true" OnPageIndexChanging="OnPaging"
                    OnRowUpdating="OnRowUpdating" OnRowDeleting="OnRowDeleting" EmptyDataText="No records have been added."
                    Width="450">
                    <Columns>
                        <asp:BoundField DataField="BL_ID" HeaderText="BL_ID" />
                        <asp:BoundField DataField="BL_NUMBER" HeaderText="BL_NUMBER" />
                        <asp:BoundField DataField="CONSIGNEE" HeaderText="CONSIGNEE" />
                        <asp:BoundField DataField="BL_TYPE" HeaderText="BL_TYPE" />
                        <asp:TemplateField HeaderText="Actions" ItemStyle-Width="150">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkEdit" runat="server" CommandName="Edit" Text="Edit" />
                                <asp:LinkButton ID="lnkDelete" runat="server" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Do you want to delete this row?');" />
                            </ItemTemplate>
                            <EditItemTemplate>
                ...
                <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
                    <tr>
                        <td style="width: 150px">
                            BL_NUMBER:<br />
                            <asp:TextBox ID="txtBLNumber" runat="server" Width="140" />
                        </td>
                        <td style="width: 150px">
                            CONSIGNEE:<br />
                            <asp:TextBox ID="txtConsignee" runat="server" Width="140" />
                        </td>
                        <td style="width: 150px">
                            BL_TYPE:<br />
                            <asp:TextBox ID="txtBLType" runat="server" Width="140" />
                        </td>
                        <td style="width: 150px">
                            <asp:Button ID="btnAdd" runat="server" Text="Add" OnClick="Insert" />
                        </td>
