<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RecordPage.aspx.vb" Inherits="School_Test.RecordPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PTML_Test</title>
    <style type="text/css">
        body
        {
            font-family: Arial;
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="gvmMain" runat="server" AutoGenerateColumns="false" OnRowDataBound="OnRowDataBound"
